...
namespace MunicipalServicesApp
{
    ...
    /// Part 2: "Local Events & Announcements" is now enabled and opens EventsForm.
    /// </summary>
    public class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "Report issues, browse events, help improve your ward.",
                AutoSize = true,
            ...
            {
                // Preferred: embedded resource (Project -> Properties -> Resources)
            ...
            // place with a 24px right margin, 22px top margin
            ...
            // If you didn’t add to Resources and instead copied municipality_logo.png to the exe folder, 
            // comment the Image= line above and use this fallback:
            // picLogo.Image = Image.FromFile("municipality_logo.png");
            ...
            // Card 2: Events & Announcements (ENABLED in Part 2)
            ...
            // Card 3: Service Request Status (still disabled for now)
            var cardStatus = CreateCardPanel(
                title: "Service Request Status",
                body: "Track the progress of your submitted issues (coming later).",
            ...
            tip.SetToolTip(cardStatus, "This feature will be implemented later.");
        }
        ...
        private Panel CreateCardPanel(string title, string body, Icon icon, string buttonText, bool enabled, EventHandler onClick)
        {
            ...
            var pic = new PictureBox { Image = icon.ToBitmap(), SizeMode = PictureBoxSizeMode.Zoom, Location = new Point(20, 18), Size = new Size(48, 48) };
        ...
        // Opens the Events & Announcements screen (Part 2)
